...
def loading_bar(total=30, delay=0.1, message="Đang khởi động tool..."):
    print()
...
\033[1;31m██║      ╚██████╔╝ ██████╔╝    ██║   ╚██████╔╝╚██████╔╝███████╗
\033[1;39m╚═╝       ╚══▀▀═╝  ╚═════╝     ╚═╝    ╚═════╝  ╚═════╝ ╚══════╝
\033[1;39m          Hoàng Sa & Trường Sa là của VIỆT NAM
\033[1;39m-----------------------------------------------------------------
{thanh} {xanh_duong}ZALO ADMIN : {trang}0336502026 (PQD-TOOL)
{thanh} {xanh_la}Zalo Box : {trang}https://zalo.me/g/mprgxe166
{thanh} {xanh_duong}IP MẠNG : {trang}{ip}
{thanh} {xanh_la}NGÀY : {trang}{ngayhomnay}/{thangnay}/{nam} [{trang}{time}]
\033[1;39m-----------------------------------------------------------------"""
    print(banner)    
...
def _delay(value):
	while not(value <= 1):
		value -= 0.123
		print(f'''\033[1;39m[\033[1;36 PPQD-TOOL\033[1;32m][ \033[1;36mDELAY \033[1;35m][\033[1;36m{str(value)[0:5]}\033[1;39m[\033[1;33mX    \033[1;39m]''', '               ', end = '\r')
		sleep(0.02)
		print(f'''\033[1;39m[\033[1;36 PPQD-TOOL\033[1;32m][ \033[1;36mDELAY \033[1;35m][\033[1;36m{str(value)[0:5]}\033[1;39m[\033[1;33m X   \033[1;39m]''', '               ', end = '\r')
		sleep(0.02)
		print(f'''\033[1;39m[\033[1;36 PPQD-TOOL\033[1;32m][ \033[1;36mDELAY \033[1;35m][\033[1;36m{str(value)[0:5]}\033[1;39m[\033[1;33m  X  \033[1;39m]''', '               ', end = '\r')
		sleep(0.02)
		print(f'''\033[1;39m[\033[1;36 PPQD-TOOL\033[1;32m][ \033[1;36mDELAY \033[1;35m][\033[1;36m{str(value)[0:5]}\033[1;39m[\033[1;33m   X \033[1;39m]''', '               ', end = '\r')
...
def Nhap_Cookie():
    ...
    while True:
        demck += 1
        ck = input(f'{xanh_duong}Nhập Cookie Facebook Thứ \033[1;33m{demck}\033[1;39m:\033[1;33m ')
        if ck == '' and demck > 1:
            break
        _info = _Infofb(ck)
        if _info == False:
            print('{do}Cookie Facebook DIE ! Vui Lòng Nhập Lại Cookie !!!')
            demck-=1
        else:
            print(f'{xanh_duong}UID FB: \033[1;35m{_info[1]} | \033[1;32mNAME FB: \033[1;35m{_info[2]}')
            print("\033[1;39m-----------------------------------------------------------------")
            listck.append(ck)
    return listck
def Main():
    ...
    banner()
    while True:
        if os.path.exists('PQDTTC.txt'):
            with open('PQDTTC.txt', 'r') as f:
                tk = f.read()
            ...
            if login.json()['status'] == 'success':
                ...
                print(f'{thanh} \033[1;32mNhập \033[1;31m[\033[1;33m1\033[1;31m] \033[1;32mĐể log vào acc \033[1;35m{user} 💸')
                print(f'{thanh} \033[1;32mNhập \033[1;31m[\033[1;33m2\033[1;31m] \033[1;32mĐể nhập access token mới💸')
                print("\033[1;39m-----------------------------------------------------------------")
                chon = str(input(f'{thanh} {xanh_la}Nhập Lựa Chọn : {tim}'))
                if chon == '2':
                    os.remove('PQDTTC.txt')
                elif chon == '1':
                    pass
                else:
                ...
                os.remove('PQDTTC.txt')
        if not os.path.exists('PQDTTC.txt'):
            banner()
            tk = input(f'{thanh} {xanh_la}Access Token TTC : \033[1;36m')
            with open('PQDTTC.txt', 'w') as f:
                f.write(tk)
        with open('PQDTTC.txt', 'r') as f:
            tk = f.read()
        login = requests.post('https://tuongtaccheo.com/logintoken.php',data={'access_token': tk})
        if login.json()['status'] == 'success':
            ...
            print(f"{tim}Tên TK TTC \033[1;39m: \033[1;33m{user} \033[1;31m| {tim}Xu Hiện Tại Đang Có \033[1;32m: \033[1;33m{sodu}")
            print("\033[1;39m-----------------------------------------------------------------")
            break
        else:
            os.remove ('PQDTTC.txt')
    ...
    banner()
    while True:
        if os.path.exists('PQDFB.txt'):
            print(f'{thanh}\033[1;32mNhập \033[1;31m[\033[1;33m1\033[1;31m] \033[1;32mĐể Dùng Cookie Trước!!🔫')
            print(f'{thanh}\033[1;32mNhập \033[1;31m[\033[1;33m2\033[1;31m] \033[1;32mĐể Nhập Lại Cookie Khác!🔫')
            print("\033[1;39m-----------------------------------------------------------------")
            chon = str(input(f'{thanh} {xanh_la}Nhập Lựa Chọn : {tim}'))
            if chon == '1':
                print(f'{tim}Đang Lấy Dữ Liệu Đã Lưu...')
                sleep(1)
                with open('PQDFB.txt', 'r') as f:
                ...
                continue
        if not os.path.exists('PQDFB.txt'):
            listck = Nhap_Cookie()
            with open('PQDFB.txt', 'w') as f:
                json.dump(listck, f)
                break
    banner()
    print(f"\033[1;32mTÀI KHOẢN TTC: \033[1;33m{user} \033[1;31m| \033[1;32mXu Hiện Tại Có: \033[1;39m{sodu} XU ")
    print('\033[1;39m-----------------------------------------------------------------')
    print(f"{thanh} \033[1;32m NHẬP \033[1;31m[\033[1;33m1\033[1;31m]\033[1;35m ĐỂ CHẠY JOB LIKE VIP")
    print(f"{thanh} \033[1;32m NHẬP \033[1;31m[\033[1;33m2\033[1;31m]\033[1;35m ĐỂ CHẠY JOB LIKE GIA RE")
    print(f"{thanh} \033[1;32m NHẬP \033[1;31m[\033[1;33m3\033[1;31m]\033[1;35m ĐỂ CHẠY JOB CAM XUC VIP")
    print(f"{thanh} \033[1;32m NHẬP \033[1;31m[\033[1;33m4\033[1;31m]\033[1;35m ĐỂ CHẠY JOB CAM XUC GIA RE")
    print(f"{thanh} \033[1;32m NHẬP \033[1;31m[\033[1;33m5\033[1;31m]\033[1;35m ĐỂ CHẠY JOB LIKE CMT")
    ...
    print(f"{thanh}  {trang}Chọn Nhiều Nhiệm Vụ \033[1;31m({xanhnhat}VD: 12345...\033[1;31m)  ")   
    print('\033[1;39m-----------------------------------------------------------------')
    ...
    while True:
        if len(listck) == 0:
            print(f' {do}Đã Xoá Tất Cả Cookie, Vui Lòng Nhập Lại Cookie Khác!!!')
            listck = Nhap_Cookie()
            with open('PQDFB.txt', 'w') as f:
                json.dump(listck, f)
        for ck in listck:
            ...
            while True:
                ...
                if nvlikevip == 1:
                    ...
                    like2 = listlike.json()
                    if like1 == []:
                        print(f'\033[1;39mHết Nhiệm Vụ Like Vip, Vui lòng đợi                           ', end = '\r');sleep(2); print('                                                        ', end = '\r')
                        nvlikevip = 0
                    elif 'error' in like2:
                        ...
                        for x in like2:
                            ...
                            if like == False:
                                print(f"\033[1;36mLike Thất Bại : \033[1;33m{uid_hidden}             ", end = '\r'); sleep(2); print('                                                       ', end = '\r')
                ...
                if nvlikethuong == 1:
                    ...
                    like2 = listlike.json()
                    if like1 == []:
                        print(f'\033[1;32mHết Nhiệm Vụ Like Thường, Vui lòng đợi                            ', end = '\r');sleep(2); print('                                                        ', end = '\r')
                        nvlikethuong = 0
                    elif 'error' in like2:
                        ...
                        for x in like2:
                            ...
                            if 'success' in getuid:
                                ...
                                print(f'\033[1;36mlink bài viết die', end = '\r'); sleep(2); print('                                                       ', end = '\r')
                                countdown(3)
                            like = _Like(ck, uid, "LIKE", _info[0], _info[1])
                            if like == False:
                                ...
                                if 'mess' in nhan:
                                    ...
                                    dem+=1
                                    time = datetime.now().strftime("%H:%M:%S")
                                    print(f'[{dem:0}][{time}][{uid_hidden}][+300][{xu}][LIKETHUONG]')
                                    loilike = 0
                                    if dem % doinick == 0:
                                        ptool = 1
                                    else:
                        ...
                        for x in like2:
                            ...
                            if like == False:
                                ...
                                if 'mess' in nhan:
                                    ...
                                    dem+=1
                                    time = datetime.now().strftime("%H:%M:%S")
                                    print(f'\033[1;31m[\033[1;33m{dem:0}\033[1;31m][\033[1;36m{time}\033[1;31m][\033[1;33m{typee}VIP\033[1;31m][\033[1;39m{uid_hidden}\033[1;31m][\033[1;33m+1100xu\033[1;31m][\033[1;32m{xu}\033[1;31m]')
                                    loicamxuc = 0
                                    if dem % doinick == 0:
                                        ptool = 1
                                    else:
